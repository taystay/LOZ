...
namespace Sprint2.SpriteClasses.LinkSprites
{
    class LinkMovingRight : ISprite
    {
        ...
        public LinkMovingRight(Texture2D sprite)
        {
            ...
            frames.Add(new Rectangle(3 * linkSprite.Width / 4, 0, linkSprite.Width / 4, linkSprite.Height / 4));
            frames.Add(new Rectangle(3 * linkSprite.Width / 4, linkSprite.Height / 4, linkSprite.Width / 4, linkSprite.Height / 4));
        }
