...
namespace Sprint2.SpriteClasses.LinkSprites
{
    class LinkMovingDown : ISprite
    {
        ...
        public LinkMovingDown(Texture2D sprite)
        {
            ...
            frames.Add(new Rectangle(0, 0, linkSprite.Width / 4, linkSprite.Height / 4));
            frames.Add(new Rectangle(0, linkSprite.Height / 4, linkSprite.Width / 4, linkSprite.Height / 4));
        }
